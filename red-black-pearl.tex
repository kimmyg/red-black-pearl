...
red-black trees are useful in functional programming
...
our characterization of the invariants allows us to have red roots, so we change our blacken function to be more conservative: instead of blackening unilaterally, it blackens only if necessary.
