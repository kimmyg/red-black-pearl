...
The salient observation/insight of Okasaki was to temporarily infringe (word) on the local property in order to make sure the global property remained satisfied. When adding a node (which happens at the bottom of the tree), we color it red, possibly infringing on the local property but keeping the global intact. This possibly introduces a violation of the local property of one of the following forms:
