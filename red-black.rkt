...
(define-compound-unit modular-set@
  ...
  (link [((empty& : empty^)) empty@]
        ...
        [((set& : set^)) custom-set@ empty& insert& delete&]))
...
(define-values/invoke-unit ml-set@
  (import)
  (export set^))
...
(module+ benchmark
  ...
  (benchmark "native sets" native-set@)
  (benchmark "modular sets" modular-set@)
  (benchmark "efficient sets" efficient-set@)
  (benchmark "ML sets" ml-set@)
